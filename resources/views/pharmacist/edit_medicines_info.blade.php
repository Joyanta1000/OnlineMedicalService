...
@endif
                  ...
                  <div class="form-group">
                    ...
                    <select name="medicines_type_id" class="form-control" id="medicines_type_id">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="medicines_name" class="form-control" id="medicines_name" placeholder="Update Medicines Name" value="{{ $medicines_info[0]->medicines_name }}">
                  </div>
                  <div class="form-group">
                    <label for="company">Company</label>
                    <input type="text" name="company" class="form-control" id="company" placeholder="Update Companies Name" value="{{ $medicines_info[0]->company }}">
                  </div>
                  <div class="form-group">
                    <label for="ingredients">Ingredients</label>
                    <input type="text" name="ingredients" class="form-control" id="ingredients" placeholder="Update Ingredients" value="{{ $medicines_info[0]->ingredients }}">
                  </div>
                  <!-- <div class="form-group">
