                        ...
                        <div class="col-md-6">
                            ...
                            <div id="app">
                                <div class="card card-primary">
                                    ...
                                    <!-- /.card-header -->
                                    <!-- form start -->
                                    <form action="/update_thana/{{ $thanas_info[0]->id }}" method="post">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="countries_id" class="form-control"
                                                    v-model="countries_id" id="country" @change="fetchData()" disabled>
                                                    <option value="{{ $thanas_info[0]->countries_id }}"
                                                        v-bind:value="countries_id"
                                                        :selected="countries_id == '{{ $thanas_info[0]->countries_id }}'">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="cities_id" class="form-control" v-model="cities_id"
                                                    id="cities_id" disabled>
                                                    <option value="{{ $thanas_info[0]->cities_id }}"
                                                        v-bind:value="cities_id"
                                                        :selected="cities_id == '{{ $thanas_info[0]->cities_id }}'">
                                                        {{ $thanas_info[0]->city }}
                                                    </option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="thana" class="form-control" id="thana"
                                                    placeholder="Update Thana" value="{{ $thanas_info[0]->thana }}">
                                            </div>
