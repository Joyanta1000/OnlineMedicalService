        ...
        <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Problem Or Disease</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{route('insert_problem')}}" method="post">
...
@endif
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="problems_name" class="form-control" id="problems_name" placeholder="Add Problem" value="{{old('problems_name')}}">
                  </div>
                  <!-- <div class="form-group">
