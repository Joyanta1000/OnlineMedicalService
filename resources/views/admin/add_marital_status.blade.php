        ...
        <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add Specialities of Doctor</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
...
@endif
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="marital_status" class="form-control" id="marital_status" placeholder="Add Marital Status" value="{{old('marital_status')}}">
                  </div>
                  <!-- <div class="form-group">
