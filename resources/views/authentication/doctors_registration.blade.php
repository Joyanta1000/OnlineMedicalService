                ...
                <input type="checkbox" name="my-checkbox" checked data-bootstrap-switch data-off-color="danger" data-on-color="success">
                  ...
                  <div id="template" class="row mt-2">
                    ...
                    <option>Washington</option>
                                        ...
                                        <input type="text" name="works_mobile_phone" class="form-control"
                    ...
                    <option>Washington</option>
                                        ...
                                        <div id="crud_table">
                                            <td>
                                                <input class="item_name" type="text" name="social_network_link[]"
                                                    style="width: 100%;">
                                            </td>
                                            <td>
                                                <div align="right">
                                                    <button type="button" name="add" id="add"
                                                        class="btn btn-success btn-xs">Add More Link</button>
                                                </div>
                                            </td>
                                        </div>
                                    </div>
                  ...
                  <input type="text" name="fax" class="form-control" style="width: 100%;">
                    ...
                    <option>Washington</option>
                                        ...
                                        <div id="speciality">
                                            <td>
                                                <input class="item_name_one" type="text" name="specialist_of[]"
                                                    style="width: 100%;">
                                            </td>
                                            <td>
                                                <div align="right">
                                    ...
                                    <div id="actions" class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <!-- <input type="file" class="custom-file-input" id="exampleInputFile"> -->
                                                    <caption style="color: red;">Upload your photo of signature
                                                    </caption> &nbsp;
                                                    <input type="file" id="exampleInputFileOne"
                                                        name="photo_of_signature" onchange="previewFileOne(this);"
