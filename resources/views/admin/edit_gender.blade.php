...
<div class="row">
        <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/update_gender/{{ $genders_info->id }}" method="post">
...
@endif
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="gender" class="form-control" id="gender" placeholder="Add Gender" value="{{ $genders_info->gender }}">
                  </div>
                  <!-- <div class="form-group">
