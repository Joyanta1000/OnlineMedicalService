...
<div class="row">
        <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/update_city/{{ $cities_info[0]->id }}" method="post">
...
@endif
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="city" class="form-control" id="city" placeholder="Update City" value="{{ $cities_info[0]->city }}">
                  </div>
                  <!-- <div class="form-group">
