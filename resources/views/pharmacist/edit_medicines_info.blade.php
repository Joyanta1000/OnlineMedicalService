        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Edit Medicine Info</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Home</a></li>
                                <li class="breadcrumb-item active">Edit Medicine Info</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Edit Medicine Info</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="/update_medicines_info/{{ $medicines_info[0]->id }}" method="post">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="medicines_type_id">Medicines Type</label>
                                            <select name="medicines_type_id" class="form-control"
                                                id="medicines_type_id">
                                                <option value="{{ $medicines_info[0]->medicines_type_id }}">
                                                    {{ $medicines_info[0]->medicine_type }}
                                                </option>
                                                @foreach ($medicine_types_info as $medicine_type)

                                                    @if ($medicine_type->id != $medicines_info[0]->medicines_type_id)
                                        ...
                                        <div class="form-group">
                                            <label for="medicines_name">Medicine</label>
                                            <input type="text" name="medicines_name" class="form-control"
                                                id="medicines_name" placeholder="Update Medicines Name"
                                                value="{{ $medicines_info[0]->medicines_name }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="company">Company</label>
                                            <input type="text" name="company" class="form-control" id="company"
                                                placeholder="Update Companies Name"
                                                value="{{ $medicines_info[0]->company }}">
                                        </div>
                                        <div class="form-group">
                                            <label for="ingredients">Ingredients</label>
                                            <input type="text" name="ingredients" class="form-control"
                                                id="ingredients" placeholder="Update Ingredients"
                                                value="{{ $medicines_info[0]->ingredients }}">
                                        </div>
                                        <!-- <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="card card-primary">
                                ...
                                <div class="card-footer">
                                    ...
                                    </a> for more examples and information about
                                    the plugin.
                                </div>
                                <!-- /.card-body -->
                            </div>
