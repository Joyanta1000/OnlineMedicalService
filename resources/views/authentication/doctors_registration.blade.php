...
<body class="hold-transition sidebar-mini">
  ...
  <form action="/register_doctor" method="post" enctype="multipart/form-data">
...
<!-- Permanent Address -->
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <input type="file" class="custom-file-input" id="exampleInputFile" name="profile_picture" onchange="previewFile(this);" value="{{old('profile_picture')}}" required>
...
<caption style="color: red;">You have to combine all certificates images in one pdf</caption>
            <input type="file" id="exampleInputFile" name="pdf_file_of_certificate" class="form-control" value="{{old('pdf_file_of_certificate')}}" required>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="work_place" class="form-control" style="width: 100%;" value="{{old('work_place')}}">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  ...
                  <input type="text" name="works_mobile_phone" class="form-control" style="width: 100%;" value="{{old('works_mobile_phone')}}">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="phonenumber" class="form-control" style="width: 100%;" value="{{old('phonenumber')}}">
                </div>
                <!-- /.form-group -->
                <div class="form-group">
                  <label>Fax</label>
                  ...
                  <input type="text" name="fax" class="form-control" style="width: 100%;" value="{{old('fax')}}">
                </div>
                <!-- /.form-group -->
              </div>
              <!-- /.col -->
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div id="crud_table">
                    <td>
                  <input class="item_name" type="text" name="social_network_link[]" style="width: 100%;">
                </td>
                <td>
                  <div align="right">
      <button type="button" name="add" id="add" class="btn btn-success btn-xs">Add More Link</button>
    </div>
  </td>
                </div>
                </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="nid_card_number" class="form-control" style="width: 100%;" value="{{old('nid_card_number')}}">
                </div>
                <!-- /.form-group -->
                <!-- <div class="form-group">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" name="birth_certificate_number" class="form-control" style="width: 100%;" value="{{old('birth_certificate_number')}}">
                </div>
                <!-- /.form-group -->
                <!-- <div class="form-group">
                  <label>Fax</label>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div id="speciality">
                    <td>
                  <input class="item_name_one" type="text" name="specialist_of[]" style="width: 100%;">
                </td>
                <td>
                  <div align="right">
      <button type="button" name="add" id="add_one" class="btn btn-success btn-xs">Add More</button>
    </div>
  </td>
                </div>
                </div>
...
<div class="form-group">
                        <label for="exampleInputFile">Photo of Signature</label>
                        <div class="input-group">
                          <div class="custom-file">
                            <!-- <input type="file" class="custom-file-input" id="exampleInputFile"> -->
<caption style="color: red;">Upload your photo of signature</caption> &nbsp;
            <input type="file" id="exampleInputFileOne" name="photo_of_signature" onchange="previewFileOne(this);" value="{{old('photo_of_signature')}}" required>
...
<br>
                        <div>
                            <img id="previewImgOne" src="" style="height: 20%; width: 20%; border-radius: 5px;" alt="Select File">
                          </div>
