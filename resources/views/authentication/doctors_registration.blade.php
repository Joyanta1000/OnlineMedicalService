                ...
                <div class="container-fluid">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group" v-if="cities_values.length">
                                                    ...
                                                    <select class="form-control" name="city_id" id="cities_id"
                                                        ...
                                                        <option value="">--Select--</option>
                                                        <option @click="fetchDataForCity(city.id)"
                                                            v-for="city in cities_values" v-bind:value="city.id">
                                                            @{{ city . city }}
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="form-group" v-if="thanas_values.length">
                                                    ...
                                                    <select class="form-control" name="thana_id" id="thanas_id"
                                                        ...
                                                        <option v-for="thana in thanas_values"
                                                            @click="fetchDataForThana(thana.id)"
                                                            v-bind:value="thana.id">
                                                            @{{ thana . thana }}
                                                        </option>
                                                    </select>
                                                    <br>
                                                ...
                                                <div class="form-group" v-if="areas_values.length">
                                                    ...
                                                    <input type="text" name="address" class="form-control"
                                                        id="address" placeholder="Add Address" v-model="address"
                                                        value="{{ old('address') }}">
                                                    <br>
                                                    <label for="zip_code">Zip Code</label>
                                                    <input type="text" name="zip_code" class="form-control"
                                                        id="zip_code" placeholder="Add Zip Code" v-model="zip_code"
                                                        value="{{ old('zip_code') }}">
                                                </div>
                                                <div>
                                                </div>
                                    ...
                                    <div id="application">
                                        <div class="card card-primary">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group" v-if="cities_values.length">
                                                    <label for="city">City</label>
                                                    <select class="form-control" name="permanent_city_id"
                                                        id="cities_id" v-model="cities_id"
                                                        value="{{ old('permanent_city_id') }}">
                                                        <option value="">--Select--</option>
                                                        <option @click="fetchDataForCity(city.id)"
                                                            v-for="city in cities_values" v-bind:value="city.id">
                                                            @{{ city . city }}
                                                ...
                                                <div class="form-group" v-if="thanas_values.length">
                                                    <label for="thana">Thana</label>
                                                    <select class="form-control" name="permanent_thana_id"
                                                        id="thanas_id" v-model="thanas_id"
                                                        value="{{ old('permanent_thana_id') }}">
                                                        <option value="">--Select--</option>
                                                        <option v-for="thana in thanas_values"
                                                            @click="fetchDataForThana(thana.id)"
                                                            v-bind:value="thana.id">
                                                ...
                                                <div class="form-group" v-if="areas_values.length">
                                                    <label for="area">Area</label>
                                                    <select class="form-control" name="permanent_area_id"
                                                        id="areas_id" v-model="areas_id"
                                                        value="{{ old('permanent_area_id') }}">
                                                        <option value="">--Select--</option>
                                                        <option v-for="area in areas_values" v-bind:value="area.id">
                                                            @{{ area . area }}
                                                        </option>
                                                    ...
                                                    <input type="text" name="permanent_address_zip_code"
                                                        class="form-control" id="permanent_address_zip_code"
                                                        placeholder="Add Zip Code" v-model="permanent_address_zip_code"
                                                ...
                                                <div class="bs-stepper-header" role="tablist">
                                                    ...
                                                    <div class="step" data-target="#information-part">
                                                        <button type="button" class="step-trigger" role="tab"
                                                            ...
                                                            <span class="bs-stepper-label">Various
                                                                information</span>
                                                        </button>
                                                    </div>
                                                </div>
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                                        ...
                                        <div class="card-body">
                                            <div id="actions" class="row">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="custom-file">
                                                            <caption style="color: red;">You have to provide
                                                                all certificates
                                                                images</caption>
                                                            <input type="file" id="exampleInputFile"
                                                                name="pdf_file_of_certificate[]" class="form-control"
                                                                value="{{ old('pdf_file_of_certificate') }}"
                                                                multiple required>
                                                        </div>
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">Upload</span>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="work_place" class="form-control"
                                                    style="width: 100%;" value="{{ old('work_place') }}">
                                            </div>
                                            <div class="form-group">
                                                <label>Works Mobile Number</label>
                                                <br>
                                                <input autocomplete="false" id="phone" type="tel"
                                                    name="works_mobile_phone" class="form-control"
                                                    style="width: 100%;" value="{{ old('works_mobile_phone') }}"
                                                    onkeydown="process(event)">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Phone Number</label>
                                                <input name="phonenumber" class="form-control" style="width: 100%;"
                                                    value="{{ old('phonenumber') }}">
                                            </div>
                                            <div class="form-group">
                                                <label>Fax</label>
                                                <input type="text" name="fax" class="form-control"
                                                    style="width: 100%;" value="{{ old('fax') }}">
                                            </div>
                                        </div>
                                    </div>
                                    <h5></h5>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div id="crud_table">
                                                    <td>
                                                        <input class="item_name" type="text"
                                                            name="social_network_link[]" style="width: 100%;">
                                                    </td>
                                                    <td>
                                                        <div align="right">
                                                            <button type="button" name="add" id="add"
                                                                class="btn btn-success btn-xs">Add More
                                                                Link</button>
                                                        </div>
                                                    </td>
                                                </div>
                            ...
                            <div class="card card-default">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label> Specialities of Doctor </label>
                                                <div id="speciality">
                                                    <td>
                                                        <input class="item_name_one" type="text"
                                                            name="specialist_of[]" style="width: 100%;">
                                                    </td>
                                                    <td>
                                                        <div align="right">
                                                            <button type="button" name="add" id="add_one"
                                ...
                                <div class="col-md-12">
                                    <div class="card card-default">
                                        ...
                                        <div class="card-body">
                                            <div id="actions" class="row">
                                                <div class="form-group">
                                                    <label for="exampleInputFile">Photo of
                                                        Signature</label>
                                                    <div class="input-group">
                                                        <div class="custom-file">
                                                            <caption style="color: red;">Upload your
                                                                photo
                                                                of signature
                                                            </caption> &nbsp;
                                                            <input type="file" id="exampleInputFileOne1"
                                                                name="photo_of_signature"
                                                                onchange="previewFileOne1(this);"
                                                                value="{{ old('photo_of_signature') }}" required>
                                                        </div>
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">Upload</span>
                                                        </div>
                            ...
                            <script>
                                function previewFileOne1(input) {
                                    var file = $("#exampleInputFileOne1").get(0).files[0];
                                    if (file) {
                                        var reader = new FileReader();

                                        reader.onload = function() {
                                            $("#previewImgOne1").attr("src", reader.result);
                                        }
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            By giving your information, you are giving the right to
                                            invastigate about you.
                                            <br>
