...
<div class="row">
        <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/update_speciality/{{ $specialities->id }}" method="post">
...
@endif
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="speciality" class="form-control" id="speciality" placeholder="Edit Speciality" value="{{ $specialities->speciality }}">
                  </div>
                  <!-- <div class="form-group">
