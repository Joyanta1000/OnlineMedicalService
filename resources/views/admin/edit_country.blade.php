...
<div class="row">
        <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/update_country/{{ $countries_info->id }}" method="post">
...
@endif
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="country" class="form-control" id="country" placeholder="Update Country" value="{{ $countries_info->country }}">
                  </div>
                  <!-- <div class="form-group">
