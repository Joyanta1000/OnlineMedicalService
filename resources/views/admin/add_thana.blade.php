...
@endif
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" id="country" v-model="countries_id" name="countries_id">
                  ...
                  <div class="form-group" v-if="cities_values.length">
                    ...
                    <select class="form-control" name="cities_id" id="cities_id" v-model="cities_id" name="cities_id">
                      <option value="">--Select--</option>
                    ...
                    <input type="text" name="thana" class="form-control" id="thana" placeholder="Add Thana" v-model="thana" value="{{old('thana')}}">
                  </div>
                  <div>
    <!-- -->
                  </div>
