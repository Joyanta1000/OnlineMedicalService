                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Edit Marital Status</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="/update_marital_status/{{ $marital_statuses->id }}" method="post">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="marital_status" class="form-control"
                                                id="marital_status" placeholder="Edit Marital Status"
                                                value="{{ $marital_statuses->marital_status }}">
                                        </div>
                                        <!-- <div class="form-group">
