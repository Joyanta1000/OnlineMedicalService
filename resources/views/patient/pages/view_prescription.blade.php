                                                ...
                                                <div
                                                    ...
                                                    <div class="container">
                                                        <div class="header">
                                                            <div>
                                                                <div class="h"
                                                                    ...
                                                                    <br>
                                                                    <span style="font-size: 15px; color: white;">Work
                                                                        Place:
                                                        ...
                                                        <div class="another_div">
                                                            ...
                                                            <div class="time" style="margin-right: 40px;">
                                                                <span>Prescribed Date:
                                                                    {{ $details->created_at->format('d-m-Y') }}</span><br>
                                                                    ...
                                                                    @foreach (App\Models\medicines_for_patients::where('prescriptions_id', $details->id)->get() as $medicines)
                                                                        <tr>
                                                                            ...
                                                                            <td> <input type="checkbox" name="" id=""
                                                                                ...
                                                                                After Food</td>
                                                                            <td>{{ $duration[$o++] }}
                                                                                @if ($duration_time[$r++] == 0) Day/Days @endif @if ($duration_time[$t++] == 1) Month/Months  @endif @if ($duration_time[$u++] == 2) Year/Years  @endif</td>
                                                                            <td> Qty: {{ $qty[$m++] }} <br> S. Note:
                                                                                {{ $short_note[$s++] }}</td>
                                                                        </tr>
                                                                    @endforeach
                                                                </tbody>
