                                                                                                ...
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        <td
                                                                                                            ...
                                                                                                            <h3 style="font-size: 30px; text-align: center;">MEDI <span style="color: #1666a3">H+</span></h3>
                                                                                                            <table
                                                                                                                class="module"
                                                                                                                role="module"
                                                                                                                data-type="spacer"
                                                                                                                                ...
                                                                                                                                <tbody>
                                                                                                                                    <tr>
                                                                                                                                        <td align="center"
                                                                                                                                            ...
                                                                                                                                            <a href="{{URL::to('/verification/'.$confirmation_code)}}"
                                                                            ...
                                                                            <div data-role="module-unsubscribe"
                                                                                ...
                                                                                <div class="Unsubscribe--addressLine">
                                                                                    ...
                                                                                    <p
                                                                                        style="font-size:12px; line-height:20px;">
                                                                                        <span
                                                                                            class="Unsubscribe--senderAddress">Sirajuddowlah Road,
                                                                                            Chittagong</span>, <span
                                                                                            class="Unsubscribe--senderCity">Chittagong</span>,
                                                                                        <span
                                                                                            class="Unsubscribe--senderState">Chittagong</span>
                                                                                        <span
                                                                                            class="Unsubscribe--senderZip">4000</span>
                                                                                    </p>
                                                                                </div>
                                                                                {{-- <p
                                                                                    style="font-size:12px; line-height:20px;">
