                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="countries_id" class="form-control"
                                                    v-model="countries_id" id="countries_id" @change="fetchData()"
                                                    disabled>

                                                    <option value="{{ $areas_info[0]->countries_id }}"
                                                        v-bind:value="countries_id"
                                                        :selected="countries_id == '{{ $areas_info[0]->countries_id }}'">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="cities_id" class="form-control" v-model="cities_id"
                                                    id="cities_id" @change="fetchDataForCity()" disabled>
                                                    <option value="{{ $areas_info[0]->cities_id }}"
                                                        v-bind:value="cities_id"
                                                        :selected="cities_id == '{{ $areas_info[0]->cities_id }}'">
                                                        {{ $areas_info[0]->city }}
                                                    </option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="thanas_id" class="form-control" v-model="thanas_id"
                                                    id="thanas_id" disabled>
                                                    <option value="{{ $areas_info[0]->thanas_id }}"
                                                        v-bind:value="thanas_id"
                                                        :selected="thanas_id == '{{ $areas_info[0]->thanas_id }}'">
                                                        {{ $areas_info[0]->thana }}
                                                    </option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="area" class="form-control" id="area"
                                                    placeholder="Update Area" value="{{ $areas_info[0]->area }}">
                                            </div>
