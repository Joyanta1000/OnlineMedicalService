                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="/update_problems_info/{{ $problems_info->id }}" method="post">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="gender">Problem</label>
                                            <input type="text" name="problems_name" class="form-control" id="gender"
                                                value="{{ $problems_info->problems_name }}">
                                        </div>
                                        <!-- <div class="form-group">
