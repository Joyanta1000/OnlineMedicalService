...
<div class="row">
        <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/insert_medicine" method="post">
...
@endif
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" id="medicines_type_id" name="medicines_type_id" value="{{old('medicines_type_id')}}">
                      <option>
                        --Select--
                      </option>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="medicines_name" class="form-control" id="medicine" placeholder="Add Medicine" value="{{old('medicines_name')}}">
                  </div>

                  <div class="form-group">
                    <label for="company">Company</label>
                    <input type="text" name="company" class="form-control" id="company" placeholder="Add Company" value="{{old('company')}}">
                  </div>

                  <div class="form-group">
                    <label for="ingredients">Ingredients</label>
                    <input type="text" name="ingredients" class="form-control" id="ingredients" placeholder="Add Ingredients" value="{{old('ingredients')}}">
                  </div>
