                  ...
                  <div class="row">
                    ...
                    @foreach($doctors_addresses as $doctors_address)
                      <ul class="ml-4 mb-0 fa-ul text-muted">
                        ...
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> Address: {{$doctors_address->address}}, {{$doctors_address->area}}, {{$doctors_address->thana}}, {{$doctors_address->city}}, {{$doctors_address->country}} </li>
                        @endif
                      </ul>
                    @endforeach
                      ...
                      <ul class="ml-4 mb-0 fa-ul text-muted">
                        ...
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span> Phone #: {{$doctor->works_mobile_phone}} </li>
                    ...
                    <div class="col-5 text-center">
                      <img src="{{$doctor->profile_picture}}" alt="user-avatar" class="img-circle img-fluid">
                    </div>
                  </div>
                </div>
