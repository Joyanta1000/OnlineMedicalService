...
<!-- Permanent Address -->
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <input type="file" class="custom-file-input" id="exampleInputFile" name="pharmacies_profile_picture" onchange="previewFile(this);" value="{{old('pharmacies_profile_picture')}}" required>
...
<caption style="color: red;">You have to combine all certificates images in one pdf</caption>
            <input type="file" id="exampleInputFile" name="evidence" class="form-control" value="{{old('pdf_file_of_certificate')}}" required>
