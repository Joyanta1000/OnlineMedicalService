...
<div class="row">
        <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="{{route('insert_city')}}" method="post">
...
@endif
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" id="country" name="countries_id" value="{{old('countries_id')}}">
                      <option>
                        --Select--
                      </option>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="city" class="form-control" id="city" placeholder="Add City" value="{{old('city')}}">
                  </div>
                  <!-- <div class="form-group">
